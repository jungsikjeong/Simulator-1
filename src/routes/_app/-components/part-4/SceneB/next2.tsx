    ...
    useEffect(() => {
        if (isTypingComplete) {
            ...
            const transitionTimer = setTimeout(() => {
                onSceneChange('part4SceneBNext3')
    ...
    return (
        <div className="relative h-screen w-full overflow-hidden">
            ...
            <div
                ...
                style={{ backgroundImage: `url('https://dmfnb4l6be84v.cloudfront.net/romance/7_%EB%B0%95%EC%A0%95%EB%AF%BC.webp')` }}
            />
            ...
            {isFading && (
                <div
                    ...
                    style={{
                        backgroundImage: `url('https://dmfnb4l6be84v.cloudfront.net/romance/8_%EB%B0%95%EC%A0%95%EB%AF%BC.webp')`,
                        opacity,
            ...
            <div className="relative z-10">
                <RomanceScene
                    ...
                    bgImage="https://dmfnb4l6be84v.cloudfront.net/romance/7_%EB%B0%95%EC%A0%95%EB%AF%BC.webp"
                    chunks={[
                        {
                    ...
                    nextBgList={['https://dmfnb4l6be84v.cloudfront.net/romance/8_%EB%B0%95%EC%A0%95%EB%AF%BC.webp']}
