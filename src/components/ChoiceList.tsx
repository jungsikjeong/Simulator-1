            ...
            {choices.map(c => (
              <motion.li key={c.key} whileTap={{ scale: 0.95 }}>
                <button
                  ...
                  className={cn(
                    /* ① 공통 레이아웃 + 애니메이션 */
                    'flex w-full cursor-pointer items-center rounded-xl border-1 border-black px-2 py-3 transition-all duration-150 ease-out hover:scale-[1.02] active:scale-100 sm:py-3 sm:pr-6 sm:pl-5',
                    /* ② 프리셋 색상/호버/포커스 */
